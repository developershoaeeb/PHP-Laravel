...
<div class="panel panel-flat">
	...
	<?php
				...
				<a href="./bannerTrushView.php" style="display: inherit;text-align: right;
	...
	?>
			<tr>
				...
				<a href="./bannerUpdate.php?banner_id=<?php echo $value ['id'];?>"><i class="icon-pencil7"></i></a>
				<a href="./bannerDelete.php?banner_id=<?php echo $value ['id'];?>"><i class="icon-trash"></i></a>
				</td>
			</tr>
			<?php } ?>
		</tbody>
